 ...
 * updates the stack pointer, and frees the memory allocated for the removed element.
 * If the stack is empty, an error message is printed and the program exits with EXIT_FAILURE.
 */
